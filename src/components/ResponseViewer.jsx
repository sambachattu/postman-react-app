    ...
    <div className="response-section">
      <div className="response-header">
        ...
        <div className="response-actions">
          {response && !response.error && (
            <>
              <button className="icon-btn" onClick={copyResponse} aria-label="Copy response" title="Copy response">
                <Copy size={18} />
              </button>
              <button className="icon-btn" onClick={downloadResponse} aria-label="Download response" title="Download response">
                <Download size={18} />
              </button>
            </>
          )}
